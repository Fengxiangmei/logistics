...
//检查输入框是否全部输入
  if (InputForm.cost.value == "")
  {
    alert("请输入计算期物流成本总额!");
    InputForm.cost.focus();
    return (false);
  }
  if (InputForm.income.value == "")
  {
    alert("请输入计算期销售收入!");
    InputForm.income.focus();
    return (false);
  }
    if (InputForm.support.value == "")
  {
    alert("请输入认同公司绿色物流的零售商数!");
    InputForm.support.focus();
    return (false);
  }
   if (InputForm.sum.value == "")
  {
    alert("请输入公司零售商总数!");
    InputForm.sum.focus();
    return (false);
